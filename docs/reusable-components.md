...
The modal contains no ad markup (AdSense compliance preserved). Confirming simply navigates to the waiting room where AdSense slots are displayed during the countdown.
